  ...
  <div class="patent-browser relative">
    ...
    <div class="fixed top-0 left-0 right-0 z-40 bg-black bg-opacity-60 backdrop-filter backdrop-blur-sm">
      <div class="container mx-auto px-4 py-4 flex items-center justify-between">
        <h1 class="text-white text-xl font-bold">Dobbin IP Law | Patent Portfolio</h1>
        <div class="flex items-center">
          <div class="relative">
            <input 
              ...
              class="bg-gray-800 text-white px-4 py-2 pr-10 rounded-full w-48 md:w-64 focus:outline-none focus:ring-2 focus:ring-dobbin-green"
            />
    ...
    />
    <div v-else class="w-full h-80 bg-gray-900 flex items-center justify-center">
...
const filteredCategories = computed(() => {
  ...
  for (const category of categories.value) {
    ...
    const filteredPatents = patents.filter(patent => 
      ...
      patent.id.toLowerCase().includes(searchQuery.value.toLowerCase())
    );
...
function handleSearch() {
  // Could implement debounce here if needed
}
